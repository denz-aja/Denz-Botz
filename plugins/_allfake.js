		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://github.com/denz-aja"			
				}
			}
		}
                global.flocation = {
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"Simple Bot OpenAi" + global.nameown ,"h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Simple Bot OpenAi","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
